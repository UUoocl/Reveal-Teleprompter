!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).SpeakerNotes =
        e());
})(this, function () {
  "use strict";
  function t() {
    ...
    emStrong(t, e, n = "") {
      ...
      if (!s || (s && ("" === n || this.rules.inline.punctuation.exec(n)))) {
        ...
        for (
          ...
          if (((a -= r), a > 0)) continue;
          if (((r = Math.min(r, r + a + o)), Math.min(n, r) % 2)) {
  ...
  (L._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
    (L.punctuation = d(L.punctuation)
      .replace(/punctuation/g, L._punctuation)
      .getRegex()),
    (L.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (L.escapedEmSt = /\\\*|\\_/g),
    (L._comment = d(A._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
    (L.emStrong.lDelim = d(L.emStrong.lDelim)
      .replace(/punct/g, L._punctuation)
      .getRegex()),
    (L.emStrong.rDelimAst = d(L.emStrong.rDelimAst, "g")
      .replace(/punct/g, L._punctuation)
      .getRegex()),
    (L.emStrong.rDelimUnd = d(L.emStrong.rDelimUnd, "g")
      .replace(/punct/g, L._punctuation)
      .getRegex()),
    (L._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (L.link = d(L.link)
      ...
      .getRegex()),
    (L.reflink = d(L.reflink)
      .replace("label", L._label)
      .replace("ref", A._label)
      .getRegex()),
    (L.nolink = d(L.nolink).replace("ref", A._label).getRegex()),
    (L.reflinkSearch = d(L.reflinkSearch, "g")
      .replace("reflink", L.reflink)
      .replace("nolink", L.nolink)
      .getRegex()),
    (L.normal = y({}, L)),
    (L.pedantic = y({}, L.normal, {
      strong: {
        start: /^__|\*\*/,
        middle:
    ...
    (L.gfm = y({}, L.normal, {
      escape: d(L.escape).replace("])", "~|])").getRegex(),
      _extended_email:
    ...
    (L.gfm.url = d(L.gfm.url, "i")
      .replace("email", L.gfm._extended_email)
      .getRegex()),
    (L.breaks = y({}, L.gfm, {
      br: d(L.br).replace("{2,}", "*").getRegex(),
      text: d(L.gfm.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
  ...
  class R {
    constructor(t) {
      ...
      const n = { block: A.normal, inline: L.normal };
      this.options.pedantic
        ? ((n.block = A.pedantic), (n.inline = L.pedantic))
        : this.options.gfm &&
          ((n.block = A.gfm),
          this.options.breaks ? (n.inline = L.breaks) : (n.inline = L.gfm)),
        (this.tokenizer.rules = n);
    }
    static get rules() {
      return { block: A, inline: L };
    }
    static lex(t, e) {
      ...
      for (; t; )
        if (
          ...
          if ((n = this.tokenizer.escape(t)))
            ...
            (t = t.substring(n.raw.length)), e.push(n);
          else if ((n = this.tokenizer.autolink(t, I)))
            (t = t.substring(n.raw.length)), e.push(n);
          else if (this.state.inLink || !(n = this.tokenizer.url(t, I))) {
            if (
              ((s = t),
  ...
  class P {
    ...
    static parse(t, e) {
      return new P(e).parse(t);
    }
    static parseInline(t, e) {
      return new P(e).parseInline(t);
    }
    parse(t, e = !0) {
      let n,
        i,
            ...
            case "list":
              for (
                ...
                (k = d.items[i]),
                  ...
                  (u += this.renderer.listitem(f, w, b));
  ...
  function N(t, e, n) {
    ...
    if (
      ...
      const r = function (t) {
        ...
        if (!t)
          try {
            e.walkTokens && N.walkTokens(s, e.walkTokens), (r = P.parse(s, e));
          } catch (e) {
            t = e;
          }
    ...
    try {
      const n = R.lex(t, e);
      return e.walkTokens && N.walkTokens(n, e.walkTokens), P.parse(n, e);
    } catch (t) {
      if (
        ((t.message +=
        ...
        return (
          "<p>An error occurred:</p><pre>" + l(t.message + "", !0) + "</pre>"
        );
      throw t;
    }
  }
  (N.options = N.setOptions =
    ...
    (N.use = function (...t) {
      ...
      t.forEach((t) => {
        if (
          ...
          const n = N.defaults.renderer || new M();
        ...
        if (t.tokenizer) {
          const n = N.defaults.tokenizer || new E();
    ...
    (N.parseInline = function (t, e) {
      ...
      T((e = y({}, N.defaults, e || {})));
      try {
        const n = R.lexInline(t, e);
        return (
          e.walkTokens && N.walkTokens(n, e.walkTokens), P.parseInline(n, e)
        );
      } catch (t) {
        if (
          ((t.message +=
  ...
  return () => {
    ...
    var i;
    function s() {
      if (n && !n.closed) n.document.getElementById("speaker-controls").focus();
      else {
        function s(t) {
          if (((a.innerHTML = t.button), 192 == t.keyCode || 0 == t.button))
            return (
              event.preventDefault(),
              (p = !p),
              (a.innerHTML = p ? "Play" + i : "Pause" + i),
              !1
            );
        }
        if (
    ...
    function r(t) {
      let s = e.getCurrentSlide(),
        r = s.querySelectorAll("aside.notes"),
        h = s.querySelector(".current-fragment"),
        g = {
          namespace: "reveal-notes",
          type: "state",
          notes: "",
      ...
      if (
        (s.hasAttribute("data-notes") &&
          ((g.notes = s.getAttribute("data-notes")),
          (g.whitespace = "pre-wrap")),
        h)
      ) {
        let t = h.querySelector("aside.notes");
        t
          ? ((g.notes = t.innerHTML),
            (g.markdown = "string" == typeof t.getAttribute("data-markdown")),
            (r = null))
          : h.hasAttribute("data-notes") &&
            ((g.notes = h.getAttribute("data-notes")),
            (g.whitespace = "pre-wrap"),
            (r = null));
      }
      r &&
        ((g.notes = Array.from(r)
          .map((t) => t.innerHTML)
          .join("\n")),
        (g.markdown =
          r[0] && "string" == typeof r[0].getAttribute("data-markdown"))),
        n.postMessage(JSON.stringify(g), "*"),
        n.document.getElementById("speaker-controls").focus(),
        n.document.getElementById("speaker-controls").scrollTo(0, 0),
        (function () {
          (p = !0),
            (u = 0),
            (a = n.document.querySelector(".overlay-element.label")),
            (o = n.document.getElementById("speaker-controls")),
            (n.document.querySelector(
              ".speaker-controls-notes"
            ).style.fontSize = l),
            (i = ", Font-size: " + l + ", Speed: " + d),
            1 == (c += 1) && setInterval(t, d);
          function t() {
            1 == p &&
              (Number(u) == Number(o.scrollHeight) - 200
                ? ((p = !1),
                  (u = 0),
                  o.scrollTo(0, 0),
                  (c = 0),
    ...
    function g() {
      e.on("slidechanged", r),
        e.on("fragmentshown", r),
        e.on("fragmenthidden", r),
        e.on("overviewhidden", r),
        e.on("overviewshown", r),
        e.on("paused", r),
        e.on("resumed", r),
        r();
    }
    return {
      ...
      init: function (t) {
        (e = t),
              ...
              : window.addEventListener("message", (t) => {
                  if (!n && "string" == typeof t.data) {
                    ...
                    i &&
                      ...
                      ((e = t.source),
                      (n && !n.closed) ||
                        ((n = e), window.addEventListener("message", h), g()),
                      n.document.getElementById("speaker-controls").focus());
                  }
                  var e;
                }),
          ...
          (l = (l = e
            .getSlidesElement()
            .querySelector("[data-speakerview-font-size]"))
            ? l.getAttribute("data-speakerview-font-size")
            : "30px"),
          (d = (d = e
            .getSlidesElement()
            .querySelector("[data-speakerview-speed]"))
            ? d.getAttribute("data-speakerview-speed")
            : 32);
      },
      open: s,
    };
